...
<head>
    ...
    <link href="<c:url value= "/static/css/trainings.css"/>" rel="stylesheet">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="row properties">
                            <form:form method="POST" action="/training" commandName="training"
                                        ...
                                        <div class="train row">
                                            ...
                                            <div class="property list-group-item row`">
                                                <div class="col-md-4 train-icons">
                                                    <c:if test="${exercise.type == 'STAMINA'}">
                                                    ...
                                                    <c:if test="${exercise.type == 'STRENGTH'}">
                                                        <div class="icon col-md-4">
                                                    ...
                                                    <c:if test="${exercise.type == 'FLEXIBILITY'}">
                                                        <div class="icon col-md-4">
                                                    ...
                                                    <c:if test="${exercise.type == 'COMMON'}">
                                                        <div class="icon col-md-4">
                                                            <img class="icon icons8-Упражнение-Filled" width="40"
                                                                 height="40"
                                                                 src="data:image/png;base64,">
                                ...
                                <div id="hidden-training-name" style="display: none;">
                                    <form:input path="name" id="training-name"/>
                                </div>
