...
<head>
    ...
    <link href="<c:url value= "/static/css/trainings.css"/>" rel="stylesheet" type='text/css'>
                            ...
                            <div class="list-group">
                                <c:forEach items="trainings" var="training">
                                    <div class="train list-group-item row">
                                        <%--<a href="${pageContext.request.contextPath}/training?name=${training.name}">--%>
                                        <a href="${pageContext.request.contextPath}/training?name=${training.name}">
                                        <div class="property row`">

                                            <div class="col-md-3 train-icons">
                                                <c:if test="${training.type == 'STAMINA'}">
                                                ...
                                                <c:if test="${training.type == 'STRENGTH'}">
                                                    <div class="icon col-md-4">
                                                ...
                                                <c:if test="${training.type == 'FLEXIBILITY'}">
                                                    <div class="icon col-md-4">
                                                ...
                                                <c:if test="${training.type == 'COMMON'}">
                                                    <div class="icon col-md-4">
                                                        <img class="icon icons8-Упражнение-Filled" width="40"
                                                             height="40"
                                                             src="data:image/png;base64,">
                                            ...
                                            <div class="col-md-3 level">
                                                ...
                                                <h4 class="level-type"
                                                        <c:if test="${training.complexity == 'BEGINNER'}">
                                                            style="color: green"
                                                        </c:if>
                                                        <c:if test="${training.complexity == 'MEDIUM'}">
                                                            style="color: orange"
                                                        </c:if>
                                                        <c:if test="${training.complexity == 'ADVANCED'}">
                                                            style="color: red"
                                                        </c:if>
