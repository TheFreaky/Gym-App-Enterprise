...
<#-- @ftlvariable name="trainings" type="java.util.List<ru.kpfu.itis.gymapp.dto.TrainingDto>" -->
...
<head>
    ...
    <link href="<@spring.url "/resources/css/trainings.css"/>" rel="stylesheet" type='text/css'>
                            ...
                            <#if trainings??>
                                <#list trainings as training>
                                    <div class="train list-group-item row">
                                        <a href="<@spring.url "/training?name=${training.name}"/>">
                                            <div class="property row`">

                                                <div class="col-md-3 train-icons">
                                                    <#if training.type == 'STAMINA'>
                                                ...
                                                <div class="col-md-3 level">
                                                    ...
                                                    <h4 class="level-type"
                                                        <#if training.complexity == 'BEGINNER'>
                                                        style="color: green"
                                                        </#if>
                                                        <#if training.complexity == 'MEDIUM'>
                                                        style="color: orange"
                                                        </#if>
                                                        <#if training.complexity == 'ADVANCED'>
                                                        style="color: red"
                                                        </#if>
